...
const NetworkImageCallbackExample = React.createClass({
...
const NetworkImageExample = React.createClass({
    getInitialState: function() {
        return {
            error: false,
            loading: false,
...
const ImageSizeExample = React.createClass({
    getInitialState: function() {
        return {
            width: 0,
            height: 0,
...
const MultipleSourcesExample = React.createClass({
    getInitialState: function() {
        return {
            width: 30,
            height: 30,
...
module.exports = NetworkImageCallbackExample;
...
exports.examples = [
    ...
    },
    {
        ...
        render: function() {
            return (
                <Image
                    defaultSource={require('../assets/personal.png')}
